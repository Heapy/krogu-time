...
import io.heapy.krogu.time.temporal.JulianFields
...
class DateTimeFormatterPatternJavaConformanceTest {
    ...
    fun numericPatternsMatchJavaTime() {
        ...
        val kroguDateTime = LocalDateTime.of(2024, 3, 1, 5, 6, 7, 8_000_000)
        val patterns = listOf(
        ...
        patterns.forEach { pattern ->
            ...
            assertEquals(javaText, kroguText, pattern)
            assertEquals(
    ...
    fun offsetPatternsMatchJavaTime() {
        ...
        val kroguDateTime = OffsetDateTime.of(
        ...
        patterns.forEach { pattern ->
            assertEquals(
                ...
                DateTimeFormatter.ofPattern(pattern).format(kroguDateTime),
                pattern,
            )
        }
    }
    ...
    fun variableWidthYearParsingMatchesJavaTime() {
        ...
        listOf("uuuMMdd", "yyyMMdd").forEach { pattern ->
            assertEquals(
                ...
                io.heapy.krogu.time.LocalDate.parse(
                    "20240229",
